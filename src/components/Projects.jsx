...
import { FaPython, FaRobot, FaBrain, FaTelegram } from 'react-icons/fa'
...
Pour le suivi et la sauvegarde des expériences, j'ai utilisé ClearML, un superbe outil open source d'expérimentation et de traçabilité des modèles IA. Il m'a permis de suivre en temps réel les métriques, visualiser les courbes d'apprentissage, et comparer facilement plusieurs versions de modèles.`,
    ...
    },
    {
      ...
      category: 'IA / Deep Learning',
      date: 'Novembre 2025',
      title: 'Pipeline IA - Segmentation d\'Images',
      shortDescription: 'Pipeline complet de segmentation d\'images utilisant YOLO avec nettoyage de dataset, création de masks et déploiement via Gradio',
      fullDescription: 'Pipeline complet de segmentation d\'images utilisant YOLO avec nettoyage de dataset, création de masks, calcul de métriques IoU & Dice, et déploiement via Gradio.',
      achievements: [
        'Segmentation précise avec métriques IoU & Dice',
        'Interface de test interactive avec Gradio',
        'Pipeline automatisé de preprocessing',
        'Possibilité de distance maps'
      ],
      technologies: ['Python', 'YOLO', 'Deep Learning', 'Gradio'],
      color: '#8b5cf6'
    },
    {
      id: 4,
